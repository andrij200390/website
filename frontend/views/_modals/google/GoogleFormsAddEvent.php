...
$modal_id = 'googleforms_add_event';
...
echo Html::tag('div',
	...
	Html::tag('div',
		Html::tag('div',
			...
			'<iframe src="https://docs.google.com/forms/d/e/1FAIpQLScjeH8ovZtSiGvoVlaFHDoo4fIpBPogtA40X_vwg4EP37NIoA/viewform?embedded=true" width="760" height="500" frameborder="0" marginheight="0" marginwidth="0">Загрузка...</iframe>'.
