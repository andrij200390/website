    ...
    <div class="modal fade" id="<?=$idDOM?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <?php $form = ActiveForm::begin(['id' => 'message-form', 'action' => Url::toRoute('message/add')]); ?>
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title"><?=Yii::t('app', 'Написать сообщение')?> <?$user->userdescriptions->name?> (<?=$user->username?>)</h4>
                </div>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary"><?=Yii::t('app', 'Написать')?></button>
